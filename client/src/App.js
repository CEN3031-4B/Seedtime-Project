...
constructor(props) {
  ...
  handleRegister = (fullname, username, password, confirm_pass, address, address2, city, states, zip, day) => {
    ...
    return axios.post('http://seed-times.herokuapp.com:5000/api/auth/register', userData)
  }
  ...
  handleLogin = (username, password) => {
    ...
    return axios.post('http://seed-times.herokuapp.com:5000/api/auth/login', userData)
  }
  ...
  handleAddProduce = (name, price, farm, description, season) => {
    ...
    axios.post('http://seed-times.herokuapp.com:5000/api/veggie', itemData)
